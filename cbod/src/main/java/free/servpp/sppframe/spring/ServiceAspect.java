...
public class ServiceAspect implements IServiceAspect {
    @Around("execution(free.cobol2java.java.CicsLinkResult free.cobol2java.java.CicsLinkService+.link(..))")
    public Object aroundCicsLink(ProceedingJoinPoint joinPoint) throws Throwable {
